    ...
    <div className={styles.main}>
      ...
      <div className={styles.section}>
        <div className={styles.copierContainer}>
          <Image alt={"lexmark 8160"} src={`/5365.webp`} width={200} height={200} />
          <div className={styles.rowSpace}>
            <div className={styles.thick}>Model:</div>
            <div>Lexmark XC5365</div>
          </div>
        </div>
        <div className={styles.centerMain}>
          <h1 className={styles.title}>Lexmark XC 5365</h1>
          <div className={styles.bulletPoint}>
            <div className={styles.flexCenter}>
              <Image alt={"lexmark 4143"} src={`/seen.webp`} width={25} height={25} />
              <div>Print speeds at 65 pages per minute</div>
            </div>
            <div className={styles.flexCenter}>
              <Image alt={"lexmark 4143"} src={`/seen.webp`} width={25} height={25} />
              <div>largest Print size is 8.5 x 14 ini</div>
            </div>
            <div className={styles.flexCenter}>
              <Image alt={"lexmark 4143"} src={`/seen.webp`} width={25} height={25} />
              <div>First page out time is 4.2</div>
            </div>
            <div className={styles.flexCenter}>
              <Image alt={"lexmark 4143"} src={`/seen.webp`} width={25} height={25} />
          ...
          <div className={styles.fifty}>
            <Link href={'/cart'}>
              <button onClick={() => {
                const updatedCart = [
                  ...cart,
                  { title: "5365", price: "", id: 1, image: "/5365.webp" }
                ]
                setCart(updatedCart)
