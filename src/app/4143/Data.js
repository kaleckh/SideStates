...
const Home = () => {
  ...
  const [title, setTitle] = useState("4143");
    ...
    <div className={styles.main}>
      ...
      <div className={styles.section}>
        <div className={styles.copierContainer}>
          <Image alt={"lexmark 8160"} src={`/4143.webp`} width={250} height={250} />
          <div className={styles.rowSpace}>
            <div className={styles.thick}>Model:</div>
            <div>Lexmark XC4143</div>
          </div>
        </div>
        <div className={styles.centerMain}>
          <h1 className={styles.title}>Lexmark XC 4143</h1>
          <div className={styles.bulletPoint}>
            ...
            <div className={styles.flexCenter}>
              <Image alt={"lexmark 4143"} src={`/seen.webp`} width={25} height={25} />
              <div>largest Print size is 8 x 11 in</div>
            </div>
            <div className={styles.flexCenter}>
              <Image alt={"lexmark 4143"} src={`/seen.webp`} width={25} height={25} />
              <div>First page out time is 6 seconds</div>
            </div>
            <div className={styles.flexCenter}>
              <Image alt={"lexmark 4143"} src={`/seen.webp`} width={25} height={25} />
          ...
          <div className={styles.fifty}>
            {toggle ? <Link href={'/cart'}>
              <button onClick={() => {
                const updatedCart = [
                  ...cart,
                  { title: "4143", price: 10, id: 1, image:"/4143.webp", quantity:5 }
                ]
                setCart(updatedCart)                
